    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function($page) {
                return '<a href="'. $page->url .'" class="btn btn-primary" target="_blank">View</a> <a href="/admin/pages/'. $page->id .'/edit" class="btn btn-primary">Edit</a><form action="'.route('admin.pages.destroy', $page->id).'" method="POST" class="d-inline">
