	...
	<form class="form-horizontal" method="POST" action="/admin/settings" enctype="multipart/form-data">
		...
		<div class="card-body">
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control" id="inputEmail3"  name="site_name" value="{{$options['site_name']}}">
				</div>
			</div>
			<div class="form-group row">
				<label for="site_description" class="col-sm-2 col-form-label">Site Description</label>
				<div class="col-sm-10">
					<textarea name="site_description" class="form-control">{{$options['site_description']}}</textarea>
				</div>
			</div>
			<div class="form-group row">
				<label for="from_email" class="col-sm-2 col-form-label">From E-mail</label>
				<div class="col-sm-10">
					<input type="text" class="form-control" id="from_email"  name="from_email" value="{{$options['from_email']}}">
				</div>
			</div>
			<div class="form-group row">
				<label for="from_name" class="col-sm-2 col-form-label">From Name</label>
				<div class="col-sm-10">
					<input type="text" class="form-control" id="from_name"  name="from_name" value="{{$options['from_name']}}">
				</div>
			</div>
			<div class="form-group row">
				...
				<small></small>
				<div class="col-sm-10">
					<input type="text" class="form-control" id="notification_email"  name="notification_email" value="{{$options['notification_email']}}">
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control" id="google_analytics_id"  name="google_analytics_id" value="{{$options['google_analytics_id']}}">
				</div>
			</div>
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<div class="custom-control custom-switch pt-2">
						<input type="checkbox" class="custom-control-input" id="maintenance_mode" name="maintenance_mode" value="1" {{$options['maintenance_mode'] == "1" ? "checked" : ""}}>
						<label class="custom-control-label" for="maintenance_mode"></label>
					</div>
					<!-- <input type="checkbox" class="form-control" id="maintenance_mode"  name="maintenance_mode" value="{{$options['maintenance_mode']}}"> -->
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control" id="business_name"  name="business_name" value="{{$options['business_name']}}">
				</div>
			</div>
			<div class="form-group row">
				<label for="business_email" class="col-sm-2 col-form-label">Business E-mail</label>
				<div class="col-sm-10">
					<input type="text" class="form-control" id="business_email"  name="business_email" value="{{$options['business_email']}}">
				</div>
			</div>
			<div class="form-group row">
				<label for="business_phone" class="col-sm-2 col-form-label">Business Phone</label>
				<div class="col-sm-10">
					<input type="text" class="form-control" id="business_phone"  name="business_phone" value="{{$options['business_phone']}}">
				</div>
			</div>
			<div class="form-group row">
				<label for="business_address" class="col-sm-2 col-form-label">Business Address</label>
				<div class="col-sm-10">
					<input type="text" class="form-control" id="business_address"  name="business_address" value="{{$options['business_address']}}">
				</div>
			</div>
			<hr>
			...
			@if ($moduleOptions != null)
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						...
						<div class="custom-control custom-switch pt-2">
							<input type="checkbox" class="custom-control-input" id="{{$moduleOption['slug']}}" name="{{$moduleOption['slug']}}" value="1" {{$options[$moduleOption['slug']] == "1" ? "checked" : ""}}>
							<label class="custom-control-label" for="{{$moduleOption['slug']}}"></label>
						</div>
						@else
						<input type="{{$moduleOption['type']}}" class="form-control" id="{{$moduleOption['slug']}}"  name="{{$moduleOption['slug']}}" value="{{$options[$moduleOption['slug']]}}">
						@endif
