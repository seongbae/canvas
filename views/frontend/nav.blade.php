...
<nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
  <div class="container">
    <a class="navbar-brand js-scroll-trigger" href="/"><img src="{{asset('img/canvas-logo-dark.png')}}" width="140px;"></a>
      ...
      <ul class="navbar-nav text-uppercase ml-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
            @can('access-admin-ui')
            <a class="dropdown-item nav-link" href="/admin/" target="_blank">
              <i aria-hidden="true" class="fas fa-fw fa-user-shield mr-2"></i> Admin
            </a>
